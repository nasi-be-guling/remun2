    ...
    public partial class Form_Identitas_ND : Form
    {
       ...
       */
        ...
        private void bSave_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add("@atasanNIP", MySqlDbType.VarChar, 19);
        ...
        private void cbJurusan_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cbJurusan.SelectedIndex == 0)
            {
                cbProgStudi.Items.AddRange(new string[] {"DIREKSI", "ADUM", "ADAK", "UNIT USAHA&KERJASAMA", "UNIT PPM", "UNIT LABORATORIUM", "UNIT LAYANAN PENGADAAN", "UNIT PENJAMINAN MUTU",
                    "UNIT TI&PROMOSI", "UNIT PERENCANAAN", "UNIT PERPUSTAKAAN", "UNIT ASRAMA"});
            }
        ...
        private void txtNIPAtasan_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
